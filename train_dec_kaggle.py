...
parser.add_argument('--cacheDir', default="/data2/coldplay/dsb_cell/cache", type=str, help='cache save directory')
...
parser.add_argument('--weightDst', default='/data2/coldplay/dsb_cell/dec_weights', type=str, help='weight save folder')
    ...
    for epoch in range(args.num_epochs):
        ...
        for phase in ['train', 'val']:
            if phase == 'train':
                ...
                writer.add_scalar('/data2/coldplay/dsb_cell/scalar/train',epoch_loss,epoch)
                if epoch % 5 == 0:
                ...
                writer.add_scalar('/data2/coldplay/dsb_cell/scalar/val_ap05',ap05,epoch)
                writer.add_scalar('/data2/coldplay/dsb_cell/scalar/val_ap07',ap07,epoch)
                if ap05>0.71:
